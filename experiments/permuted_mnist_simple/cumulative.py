...
def cumulative_pmnist_simple(override_args=None):
    ...
    args = create_default_args({'cuda': 1,
                                ...
                                'seed': 0,
                                'no_experiences': 10,
                                'log_path': './logs/p_mnist_simple/cumulative/'}, override_args)
    set_seed(args.seed)
    ...
    cl_strategy = avl.training.Cumulative(
        ...
        eval_mb_size=args.eval_mb_size, device=device, evaluator=evaluation_plugin)
